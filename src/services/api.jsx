...
const response = (searchQueryPicture, page) => {
  return fetch(
    `${BASE_URL}?key=${MY_API_KEY}&q=${searchQueryPicture}&image_type=photo&orientation=horizontal&safesearch=true&per_page=12&page=${page}`
